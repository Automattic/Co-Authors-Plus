	...
	public function coauthors_meta_box( $post ) {
		...
		if ( ! empty( $coauthors ) ) :
			...
			<div id="coauthors-readonly" class="hide-if-js">
				...
				<div class="clear"></div>
				<p><?php wp_kses_post( _e( '<strong>Note:</strong> To edit post authors, please enable javascript or use a javascript-capable browser', 'co-authors-plus' ) ); ?></p>
			</div>
			<?php
		endif;
		?>
		...
		<div id="coauthors-edit" class="hide-if-no-js">
			<p><?php wp_kses_post( _e( 'Click on an author to change them. Drag to change their order. Click on <strong>Remove</strong> to remove them.', 'co-authors-plus' ) ); ?></p>
		</div>
